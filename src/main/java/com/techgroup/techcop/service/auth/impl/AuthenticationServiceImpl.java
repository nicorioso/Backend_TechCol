...
public class AuthenticationServiceImpl implements AuthenticationService {
    ...
    @Override
    public AuthResponse authenticateWithGoogle(String credential, HttpServletResponse response) {
        ...
        Customer customer = customerRepository.findByCustomerEmail(tokenInfo.getEmail().trim().toLowerCase())
    ...
    private Customer mergeGoogleProfile(Customer customer, GoogleTokenInfo tokenInfo) {
    ...
    private AuthResponse createAuthResponse(Customer customer, HttpServletResponse response, boolean includeRefreshCookie) {
